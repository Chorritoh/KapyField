...
local Release = "KF Version 1.0.1 | Beta 8" -- Its the same that 1.0.0 version lol.
...
local KapyFieldLibrary = {
	Flags = {},
	Theme = {
		Default = {
			TextFont = "Default", -- Default will use the various font faces used across KapyField
		...
		Light = {
			TextFont = "Gotham", -- Default will use the various font faces used across KapyField
...
local KapyField = game:GetObjects("rbxassetid://18319472305")[1]

KapyField.Enabled = false


if gethui then
	KapyField.Parent = gethui()
elseif syn.protect_gui then 
	syn.protect_gui(KapyField)
	KapyField.Parent = CoreGui
elseif CoreGui:FindFirstChild("RobloxGui") then
	KapyField.Parent = CoreGui:FindFirstChild("RobloxGui")
else
	KapyField.Parent = CoreGui
end
...
if gethui then
	for _, Interface in ipairs(gethui():GetChildren()) do
		if Interface.Name == KapyField.Name and Interface ~= KapyField then
			Interface.Enabled = false
			Interface.Name = "KapyField-Old"
		end
	end
else
...
local Main = KapyField.Main
local Topbar = Main.Topbar
local Elements = Main.Elements
local LoadingFrame = Main.LoadingFrame
local TabList = Main.TabList

KapyField.DisplayOrder = 100
...
local Notifications = KapyField.Notifications

local SelectedTheme = KapyFieldLibrary.Theme.Default

function ChangeTheme(ThemeName)
	SelectedTheme = KapyFieldLibrary.Theme[ThemeName]
	for _, obj in ipairs(KapyField:GetDescendants()) do
	...
	KapyField.Main.BackgroundColor3 = SelectedTheme.Background
	KapyField.Main.Topbar.BackgroundColor3 = SelectedTheme.Topbar
	KapyField.Main.Topbar.CornerRepair.BackgroundColor3 = SelectedTheme.Topbar
	KapyField.Main.Shadow.Image.ImageColor3 = SelectedTheme.Shadow

	KapyField.Main.Topbar.ChangeSize.ImageColor3 = SelectedTheme.TextColor
	KapyField.Main.Topbar.Hide.ImageColor3 = SelectedTheme.TextColor
	KapyField.Main.Topbar.Theme.ImageColor3 = SelectedTheme.TextColor
...
local function LoadConfiguration(Configuration)
	...
	for FlagName, FlagValue in next, Data do
		if KapyFieldLibrary.Flags[FlagName] then
			spawn(function() 
				if KapyFieldLibrary.Flags[FlagName].Type == "ColorPicker" then
					KapyFieldLibrary.Flags[FlagName]:Set(UnpackColor(FlagValue))
				else
					if KapyFieldLibrary.Flags[FlagName].CurrentValue or KapyFieldLibrary.Flags[FlagName].CurrentKeybind or KapyFieldLibrary.Flags[FlagName].CurrentOption or KapyFieldLibrary.Flags[FlagName].Color ~= FlagValue then KapyFieldLibrary.Flags[FlagName]:Set(FlagValue) end
				end    
			end)
		else
			KapyFieldLibrary:Notify({Title = "Flag Error", Content = "KapyField was unable to find '"..FlagName.. "'' in the current script"})
		end
	end
end
...
local function SaveConfiguration()
	...
	local Data = {}
	for i,v in pairs(KapyFieldLibrary.Flags) do
...
function KapyFieldLibrary:Notify(NotificationSettings)
	spawn(function()
		...
		if NotificationSettings.Actions then
			for _, Action in pairs(NotificationSettings.Actions) do
				...
				if SelectedTheme ~= KapyFieldLibrary.Theme.Default then
				...
				NewAction.MouseButton1Click:Connect(function()
					...
					if not Success then
						print("KapyField | Action: "..Action.Name.." Callback Error " ..tostring(Response))
					end
		...
		if KapyField.Name == "KapyField" then
...
function Hide()
	Debounce = true
	KapyFieldLibrary:Notify({Title = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by tapping K", Duration = 7})
	TweenService:Create(Main, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {Size = UDim2.new(0, 470, 0, 680)}):Play()
	TweenService:Create(Main.Topbar, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {Size = UDim2.new(0, 470, 0, 69)}):Play()
	...
	TweenService:Create(Main.Topbar.VisualDivider, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 1}):Play()
	...
	TweenService:Create(Main.UIStroke, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {Transparency = 1}):Play()
...
function Unhide()
	...
	Main.Visible = true
	TweenService:Create(Main, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {Size = UDim2.new(0, 500, 0, 703)}):Play()
	TweenService:Create(Main.Topbar, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {Size = UDim2.new(0, 500, 0, 69)}):Play()
	TweenService:Create(Main.Shadow.Image, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {ImageTransparency = 0.5}):Play()
	TweenService:Create(Main, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 0.4}):Play()
	...
	TweenService:Create(Main.Topbar.VisualDivider, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 0}):Play()
	...
	TweenService:Create(Main.UIStroke, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {Transparency = 0}):Play()
...
function Maximise()
	...
	TweenService:Create(Main, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {Size = UDim2.new(0, 500, 0, 703)}):Play()
	TweenService:Create(Topbar, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {Size = UDim2.new(0, 500, 0, 69)}):Play()
...
function KapyFieldLibrary:CreateWindow(Settings)
	...
	LoadingFrame.Title.Text = Settings.LoadingTitle or "KapyField Interface Suite"
	LoadingFrame.Subtitle.Text = Settings.LoadingSubtitle or "by Sirius"
	if Settings.LoadingTitle ~= "KapyField Interface Suite" then
		LoadingFrame.Version.Text = "KapyField UI"
	end
	...
	pcall(function()
		...
		if not isfolder(KapyFieldFolder.."/".."Configuration Folders") then
	...
	if Settings.Discord then
		if not isfolder(KapyFieldFolder.."/Discord Invites") then
			makefolder(KapyFieldFolder.."/Discord Invites")
		end
		if not isfile(KapyFieldFolder.."/Discord Invites".."/"..Settings.Discord.Invite..ConfigurationExtension) then
			if request then
				request({
			...
			if Settings.Discord.RememberJoins then -- We do logic this way so if the developer changes this setting, the user still won't be prompted, only new users
				writefile(KapyFieldFolder.."/Discord Invites".."/"..Settings.Discord.Invite..ConfigurationExtension,"KapyField RememberJoins is true for this invite, this invite will not ask you to join again")
			end
		else
	...
	if Settings.KeySystem then
		...
		if not isfolder(KapyFieldFolder.."/Key System") then
			makefolder(KapyFieldFolder.."/Key System")
		end
		...
		if Settings.KeySettings.GrabKeyFromSite then
			for i, Key in ipairs(Settings.KeySettings.Key) do
				...
				if not Success then
					print("KapyField | "..Key.." Error " ..tostring(Response))
				end
			end
		end
		...
		if isfile(KapyFieldFolder.."/Key System".."/"..Settings.KeySettings.FileName..ConfigurationExtension) then
			for _, MKey in ipairs(Settings.KeySettings.Key) do
				if string.find(readfile(KapyFieldFolder.."/Key System".."/"..Settings.KeySettings.FileName..ConfigurationExtension), MKey) then
					Passthrough = true
				end
			end
		end
			...
			KeyUI.Main.Input.InputBox.FocusLost:Connect(function()
				...
				if KeyFound then 
					...
					if Settings.KeySettings.SaveKey then
						if writefile then
							writefile(KapyFieldFolder.."/Key System".."/"..Settings.KeySettings.FileName..ConfigurationExtension, FoundKey)
						end
						KapyFieldLibrary:Notify({Title = "Key System", Content = "The key for this script has been saved successfully"})
					end
				else
	...
	KapyField.Enabled = true
	wait(0.5)
	TweenService:Create(Main, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {BackgroundTransparency = 0.4}):Play()
	TweenService:Create(Main.UIStroke, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {Transparency = 0.4}):Play()
	...
	function Window:CreateTab(Name,Image)
		...
		TabButton.Interact.MouseButton1Click:Connect(function()
			...
			if Elements.UIPageLayout.CurrentPage ~= TabPage then
				TweenService:Create(Elements, TweenInfo.new(1, Enum.EasingStyle.Quint), {Size = UDim2.new(0, 475,0, 594)}):Play()
				Elements.UIPageLayout:JumpTo(TabPage)
				wait(0.2)
				TweenService:Create(Elements, TweenInfo.new(0.8, Enum.EasingStyle.Quint), {Size = UDim2.new(0, 475,0, 594)}):Play()
			end
		...
		function Tab:CreateButton(ButtonSettings)
			...
			Button.Interact.MouseButton1Click:Connect(function()
				...
				if not Success then
					...
					print("KapyField | "..ButtonSettings.Name.." Callback Error " ..tostring(Response))
					wait(0.5)
					Button.Title.Text = ButtonSettings.Name
		...
		function Tab:CreateColorPicker(ColorPickerSettings) -- by Throit
			...
			if Settings.ConfigurationSaving then
				if Settings.ConfigurationSaving.Enabled and ColorPickerSettings.Flag then
					KapyFieldLibrary.Flags[ColorPickerSettings.Flag] = ColorPickerSettings
				end
			end
		...
		function Tab:CreateInput(InputSettings)
			...
			Input.InputFrame.InputBox.FocusLost:Connect(function()
				...
				if not Success then
					...
					print("KapyField | "..InputSettings.Name.." Callback Error " ..tostring(Response))
					wait(0.5)
					Input.Title.Text = InputSettings.Name
		...
		function Tab:CreateDropdown(DropdownSettings)
			...
			for _, Option in ipairs(DropdownSettings.Options) do
				...
				DropdownOption.Interact.MouseButton1Click:Connect(function()
					...
					if not Success then
						...
						print("KapyField | "..DropdownSettings.Name.." Callback Error " ..tostring(Response))
						wait(0.5)
						Dropdown.Title.Text = DropdownSettings.Name
						TweenService:Create(Dropdown, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
			...
			if Settings.ConfigurationSaving then
				if Settings.ConfigurationSaving.Enabled and DropdownSettings.Flag then
					KapyFieldLibrary.Flags[DropdownSettings.Flag] = DropdownSettings
				end
			end
		...
		function Tab:CreateKeybind(KeybindSettings)
				...
				elseif KeybindSettings.CurrentKeybind ~= nil and (input.KeyCode == Enum.KeyCode[KeybindSettings.CurrentKeybind] and not processed) then -- Test
					...
					if not KeybindSettings.HoldToInteract then
						...
						if not Success then
							...
							print("KapyField | "..KeybindSettings.Name.." Callback Error " ..tostring(Response))
							wait(0.5)
							Keybind.Title.Text = KeybindSettings.Name
							TweenService:Create(Keybind, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
			...
			if Settings.ConfigurationSaving then
				if Settings.ConfigurationSaving.Enabled and KeybindSettings.Flag then
					KapyFieldLibrary.Flags[KeybindSettings.Flag] = KeybindSettings
				end
			end
		...
		function Tab:CreateToggle(ToggleSettings)
			...
			Toggle.Interact.MouseButton1Click:Connect(function()
				...
				if not Success then
					...
					print("KapyField | "..ToggleSettings.Name.." Callback Error " ..tostring(Response))
					wait(0.5)
					Toggle.Title.Text = ToggleSettings.Name
					TweenService:Create(Toggle, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
					TweenService:Create(Toggle.UIStroke, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {Transparency = 0}):Play()
			...
			if Settings.ConfigurationSaving then
				if Settings.ConfigurationSaving.Enabled and ToggleSettings.Flag then
					KapyFieldLibrary.Flags[ToggleSettings.Flag] = ToggleSettings
				end
			end
		...
		function Tab:CreateSlider(SliderSettings)
					...
					if Dragging then
						...
						if SliderSettings.CurrentValue ~= NewValue then
							...
							if not Success then
								...
								print("KapyField | "..SliderSettings.Name.." Callback Error " ..tostring(Response))
								wait(0.5)
								Slider.Title.Text = SliderSettings.Name
								TweenService:Create(Slider, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
			...
			if Settings.ConfigurationSaving then
				if Settings.ConfigurationSaving.Enabled and SliderSettings.Flag then
					KapyFieldLibrary.Flags[SliderSettings.Flag] = SliderSettings
				end
			end
	...
	wait(0.2)
	TweenService:Create(Main, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {Size = UDim2.new(0, 500, 0, 703)}):Play()
...
function KapyFieldLibrary:Destroy()
	KapyField:Destroy()
end
...
function KapyFieldLibrary:LoadConfiguration()
	if CEnabled then
		pcall(function()
			if isfile(ConfigurationFolder .. "/" .. CFileName .. ConfigurationExtension) then
				LoadConfiguration(readfile(ConfigurationFolder .. "/" .. CFileName .. ConfigurationExtension))
				KapyFieldLibrary:Notify({Title = "Configuration Loaded", Content = "The configuration file for this script has been loaded from a previous session"})
			end
		end)
	end
end

task.delay(3.5, KapyFieldLibrary.LoadConfiguration, KapyFieldLibrary)

return KapyFieldLibrary
